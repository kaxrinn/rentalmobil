...
<section class="mt-[50px] py-[50px] px-[20px] bg-white shadow-lg rounded-[10px] mb-[15px]">
  <div class="flex flex-col md:flex-row items-center justify-center gap-[30px] max-w-[1200px] w-full mx-auto">
    
    <!-- Gambar -->
    <div class="w-full max-w-[300px]">
      <img src="{{ asset('gambarberanda/gambar 4.jpeg') }}" alt="Mobil" class="w-full rounded-[10px]">
    </div>

    <!-- Teks -->
    <div class="w-full max-w-[600px]">
      <h2 class="text-[20px] md:text-[24px] text-[#1e2b5c] font-bold mb-[20px]">
        <span class="text-[#1e2b5c] font-bold mr-[10px]">|</span> TENTANG APLIKASI
      </h2>
      <p class="text-[15px] md:text-[16px] leading-[1.7] mb-[15px] text-justify">
