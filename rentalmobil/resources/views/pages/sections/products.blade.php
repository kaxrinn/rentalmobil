<section id="Produk" class="py-12 px-6 text-center bg-[#F9FAFF]">
  ...
  <div class="relative max-w-[1300px] mx-auto">
    <div id="products-carousel" class="relative" data-carousel="static">
      ...
      <!-- Navigation buttons - positioned at the sides (middle vertically) -->
      <button type="button" class="absolute top-1/2 -left-4 z-30 -translate-y-1/2 flex items-center justify-center w-10 h-10 rounded-full bg-[#1e2b5c] text-white hover:bg-[#152049] focus:outline-none" data-carousel-prev>
        <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
          <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 1 1 5l4 4"/>
        </svg>
        <span class="sr-only">Previous</span>
      </button>
      <button type="button" class="absolute top-1/2 -right-4 z-30 -translate-y-1/2 flex items-center justify-center w-10 h-10 rounded-full bg-[#1e2b5c] text-white hover:bg-[#152049] focus:outline-none" data-carousel-next>
        <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
