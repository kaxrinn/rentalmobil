            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 px-4">
              ...
              <div class="border border-gray-300 rounded-[10px] p-4 bg-white shadow-md">
                ...
                <div class="flex justify-center space-x-2">
                  ...
                  <button data-modal-target="order-modal" data-modal-toggle="order-modal" onclick="setSelectedCar('Honda Brio')" class="px-4 py-2 bg-[#1e2b5c] text-white rounded text-sm">Sewa</button>
                </div>
              </div>
              ...
              <div class="border border-gray-300 rounded-[10px] p-4 bg-white shadow-md">
                ...
                <div class="flex justify-center space-x-2">
                  ...
                  <button data-modal-target="order-modal" data-modal-toggle="order-modal" onclick="setSelectedCar('Suzuki Ertiga')" class="px-4 py-2 bg-[#1e2b5c] text-white rounded text-sm">Sewa</button>
                </div>
              </div>
              ...
              <div class="border border-gray-300 rounded-[10px] p-4 bg-white shadow-md">
                ...
                <div class="flex justify-center space-x-2">
                  ...
                  <button data-modal-target="order-modal" data-modal-toggle="order-modal" onclick="setSelectedCar('Daihatsu Xenia')" class="px-4 py-2 bg-[#1e2b5c] text-white rounded text-sm">Sewa</button>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 px-4">
              ...
              <div class="border border-gray-300 rounded-[10px] p-4 bg-white shadow-md">
                ...
                <div class="flex justify-center space-x-2">
                  ...
                  <button data-modal-target="order-modal" data-modal-toggle="order-modal" onclick="setSelectedCar('Mitsubishi Xpander')" class="px-4-2 bg-[#1e2b5c] text-white rounded text-sm">Sewa</button>
                </div>
              </div>
              ...
              <div class="border border-gray-300 rounded-[10px] p-4 bg-white shadow-md">
                ...
                <div class="flex justify-center space-x-2">
                  ...
                  <button data-modal-target="order-modal" data-modal-toggle="order-modal" onclick="setSelectedCar('Nissan Livina')" class="px-4 py-2 bg-[#1e2b5c] text-white rounded text-sm">Sewa</button>
                </div>
              </div>
              ...
              <div class="border border-gray-300 rounded-[10px] p-4 bg-white shadow-md">
                ...
                <div class="flex justify-center space-x-2">
                  ...
                  <button data-modal-target="order-modal" data-modal-toggle="order-modal" onclick="setSelectedCar('Wuling Almaz')" class="px-4 py-2 bg-[#1e2b5c] text-white rounded text-sm">Sewa</button>
                </div>
              </div>
              ...
              <div class="border border-gray-300 rounded-[10px] p-4 bg-white shadow-md">
                ...
                <div class="flex justify-center space-x-2">
                  ...
                  <button data-modal-target="order-modal" data-modal-toggle="order-modal" onclick="setSelectedCar('Toyota Avanza')" class="px-4 py-2 bg-[#1e2b5c] text-white rounded text-sm">Sewa</button>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 px-4">
              ...
              <div class="border border-gray-300 rounded-[10px] p-4 bg-white shadow-md">
                ...
                <div class="flex justify-center space-x-2">
                  ...
                  <button data-modal-target="order-modal" data-modal-toggle="order-modal" onclick="setSelectedCar('Honda Mobilio')" class="px-4 py-2 bg-[#1e2b5c] text-white rounded text-sm">Sewa</button>
                </div>
              </div>
              ...
              <div class="border border-gray-300 rounded-[10px] p-4 bg-white shadow-md">
                ...
                <div class="flex justify-center space-x-2">
                  ...
                  <button data-modal-target="order-modal" data-modal-toggle="order-modal" onclick="setSelectedCar('Kia Sonet')" class="px-4 py-2 bg-[#1e2b5c] text-white rounded text-sm">Sewa</button>
                </div>
              </div>
              ...
              <div class="border border-gray-300 rounded-[10px] p-4 bg-white shadow-md">
                ...
                <div class="flex justify-center space-x-2">
                  ...
                  <button data-modal-target="order-modal" data-modal-toggle="order-modal" onclick="setSelectedCar('Hyundai Stargazer')" class="px-4 py-2 bg-[#1e2b5c] text-white rounded text-sm">Sewa</button>
                </div>
              </div>
              ...
              <div class="border border-gray-300 rounded-[10px] p-4 bg-white shadow-md">
                ...
                <div class="flex justify-center space-x-2">
                  ...
                  <button data-modal-target="order-modal" data-modal-toggle="order-modal" onclick="setSelectedCar('Mazda CX-3')" class="px-4 py-2 bg-[#1e2b5c] text-white rounded text-sm">Sewa</button>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="p-6">
          <form class="space-y-4">
            ...
            <div>
              ...
              <select id="selected-car" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            ...
            <div>
              ...
              <input type="text" placeholder="Masukkan nama lengkap Anda" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            </div>

            <!-- Email -->
            <div>
              <label class="block mb-2 text-sm font-medium text-gray-900">Email</label>
              <input type="email" placeholder="Masukkan alamat email akun Anda" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            </div>

            <!-- Alamat -->
            <div>
              <label class="block mb-2 text-sm font-medium text-gray-900">Alamat</label>
              <input type="text" placeholder="Masukkan alamat Anda" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            </div>

            <!-- Nomor Handphone -->
            <div>
              <label class="block mb-2 text-sm font-medium text-gray-900">Nomor Handphone</label>
              <input type="tel" placeholder="Masukkan nomor telepon Anda" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            </div>
            ...
            <div>
              ...
              <input type="text" value="Tiban Indah Permai Blok Z1" readonly class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="text" value="Rp. 500.000" readonly class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
              </div>

              <!-- Nomor Rekening -->
              <div>
                <label class="block mb-2 text-sm font-medium text-gray-900">Nomor Rekening</label>
                <input type="text" value="3244657545346 (BNI) a/n VROOM" readonly class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
              </div>
            </div>
